...
//             <a href="https://www.facebook.com/profile.php?id=61575315973041" target="_blank" rel="noopener noreferrer" aria-label="Facebook Page" className="hover:text-orange-600 transition duration-300 ease-in-out">
...
//                     href="/products"
//                     className={`hover:text-orange-600 transition duration-300 ease-in-out ${
//                       pathname === '/products' ? 'text-orange-600 font-bold' : '' // Active class
//                     }`}
//                   >
//                     All Products
//                   </Link>
...
//               href="/products"
//               className={`block text-base text-gray-700 hover:text-orange-600 transition duration-300 ease-in-out py-2 px-3 rounded-md hover:bg-gray-50 ${
//                 pathname === '/products' ? 'text-orange-600 font-bold bg-gray-100' : '' // Active class with background
//               }`}
//               onClick={() => setMobileMenuOpen(false)} // Close menu on click
//             >
//               All Products
            ...
            <ul className="flex items-center space-x-8 lg:space-x-10 text-base font-medium text-gray-700">
              ...
              <li>
                <Link
                  href="/products"
                  className={`hover:text-orange-600 transition ${
                    pathname === "/products" ? "text-orange-600 font-bold" : ""
                  }`}
                >
                  All Products
                </Link>
              ...
              <li className="relative group" ref={dropdownRef}>
                ...
                <div className="absolute top-full left-0 mt-0 w-56 bg-white rounded-md shadow-lg py-2 ring-1 ring-black ring-opacity-5 hidden group-hover:block transition origin-top">
                  <Link
              ...
              <li>
                <Link
                  ...
                  className={`flex items-center hover:text-orange-600 transition ${
                    pathname === "/cart" ? "text-orange-600 font-bold" : ""
                  }`}
                >
